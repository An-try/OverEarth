...
{
    public static PlayerShipCameraController instance; // Singleton for this script

    public GameObject PlayerShip;

    private Camera PlayerShipCamera;
    ...
    private float scrollWheelSensitivity = 100f;
    private float scrollMax = 1000f;
    ...
    {
        PlayerShipCamera = GetComponent<Camera>(); // Get camera component on this game object
        cameraDefaultFieldOfView = PlayerShipCamera.fieldOfView; // Set the current camera field of view as default
        cameraAimRayLength = PlayerShipCamera.farClipPlane; // Set ray length
    ...
    private void Update() // Update is called every frame
    {
        ...
        if (Cursor.visible)
        {
            PlayerShipCamera.fieldOfView = cameraDefaultFieldOfView; // Set default camera field of view
        ...
        {
            PlayerShipCamera.fieldOfView = zoomedCameraFieldOfView; // Set new camera field of view
