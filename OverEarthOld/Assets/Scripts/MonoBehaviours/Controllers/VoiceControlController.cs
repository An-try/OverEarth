...
namespace OverEarth
{
    public class VoiceControlController : Singleton<VoiceControlController>
    {
        ...
        private protected override void Awake() // Awake is called when the script instance is being loaded
        {
            ...
            MoveDirectionActions.Add("backward", BackwardDirectionAction);
        ...
        {
            PlayerShipController.Instance.UpdateTransmissionByValue(4);
        }

        private void BackwardDirectionAction() // Move player ship backward
        {
            PlayerShipController.Instance.UpdateTransmissionByValue(-4);
        }
        ...
        {
            PlayerShipController.Instance.UpdateTransmissionByValue(0);
        }
